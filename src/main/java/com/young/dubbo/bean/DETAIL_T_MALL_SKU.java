...
public class DETAIL_T_MALL_SKU extends T_MALL_SKU {
	...
	private List<OBJECT_T_MALL_ATTR_VALUE_NAME> list_av_name;
	...
	public List<OBJECT_T_MALL_ATTR_VALUE_NAME> getList_av_name() {
		return list_av_name;
	}

	public void setList_av_name(List<OBJECT_T_MALL_ATTR_VALUE_NAME> list_av_name) {
